				...
				<Row className="justify-content-center">
					<Col className="col-12 col-md-10 col-lg-6">
						...
						<div className="section-title text-center">
							...
							<p>There are so many ways (and places) you can fill your wallet on Caléna. Here are a few we think are fun right now:</p>
						</div>
					...
					<Col className="col-12 col-lg-4 res-margin">
						...
						<div className="blog-col">
							...
							<p>
								...
								<span className="blog-category">Resorts</span>
							</p>
							...
							<div className="blog-wrapper">
								<div className="blog-text">
									...
									<h4>
										<a href="#">Assorted Color Buildings and Sea in Riomaggiore</a>
									</h4>
						...
						<div className="blog-col">
							...
							<div className="blog-wrapper">
								<div className="blog-text">
									...
									<h4>
										<a href="#">Aerial Photography of Snowy Mountain Ranges</a>
									</h4>
						...
						<div className="blog-col">
							...
							<div className="blog-wrapper">
								<div className="blog-text">
									...
									<h4>
										<a href="#">Forest Highway With Green Leaves</a>
									</h4>
