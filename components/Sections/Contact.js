                ...
                <Row className="justify-content-center">
                    <div className="col-12 col-md-10 col-lg-6">
                        ...
                        <div className="section-title text-center">
                            <h3>Ready to start earning free cash?</h3>
                            <p>Your favorite brands choose to give you cash back offers via Caléna, instead of spending it on disruptive advertising. How cool is that? With Caléna, it all adds up. </p>
                        </div>
